...
function LandingTwo() {
  ...
  return (
    <section className=" flex justify-center items-center mt-2 border-[#dad4d4] border-2 rounded-[15px] bgurl bg-contain relative mx-auto w-[99.3%] overflow-hidden h-[93vh] lg:h-[89vh]  3xl:h-[89vh] ">
      <div className=" rotate-12  absolute z-10 hidden top-0 -left-5 xl:-top-2 xl: lg:block 2xl:-top-4 2xl:left-5 ">
      ...
      <div className=" rotate-3  absolute z-10 hidden lg:block bottom-10 left-16 2xl:bottom-12 2xl:left-32 ">
        <div className="relative">
          <Images
            url={leftTwo}
      ...
      <div className=" -rotate-3  absolute z-10 hidden lg:block -bottom-36 -right-8 xl:-bottom-48 xl:-right-10 2xl:-bottom-56 2xl:-right-12 ">
        <div className="relative">
          <Images
            url={rightOne}
      ...
      <div className=" -rotate-12  absolute z-10 hidden lg:block top-10 right-12 xl:top-10 xl:right-12 ">
        <Images
          url={rightTwo}
      ...
      <div className=" flex flex-col items-center space-y-8 font-fontNunito text-center mb-6 ">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <MotionH2
            {...animatedLandingTwo}
            className="text-4xl sm:text-5xl md:text-6xl  xl:text-7xl inline-block text-textColor rounded-sm px-3 py-2 font-bold mx-auto w-fit  "
          >
            {t("title")}
          </MotionH2>
        </div>
