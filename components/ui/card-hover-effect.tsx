...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-primary border border-neutral-700 border-transparent dark:border-white/[0.7] group-hover:border-slate-900 relative z-20 dark:border-neutral-900",
        className
      )}
    >
