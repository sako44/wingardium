...
function Terms() {
  ...
  return (
    <section className="py-5 my-12 font-fontNunito">
      <Container clas=" flex flex-col space-y-16 ">
        <AnimatedHeader title="Terms and Services" />
        <div className="flex flex-col lg:flex-row max-lg:space-y-8 lg:space-x-12 xl:space-x-24 xs:px-12
         sm:px-20 md:px-28 lg:px-0">
          <div className="flex flex-col space-y-5 bg-bgColor rounded-xl p-4 lg:p-7 lg:w-full 2xl:max-w-[45%]">
